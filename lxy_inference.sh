...
model_tag="cosine1.5b-qwen-len_4096-see_cur_false-bi_false-diag_false-mode_aug-wo-pc-prefill_compress_false-hybrid_false-epoch_5-lr_2e-5-bsz_8-accumu_2-warm_r_0.05-warm_s_0-freeze_model_false-train_input_false-qkv_no-ex_con_false"

# `model_short_tag` is used to save file, 
# corresponding to line 1691 of the code in LightThinker/inference.py.
model_short_tag="inf_lightthinker_r1distillqwen1.5b"
